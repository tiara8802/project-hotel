...
<main class="form-signin w-100 m-auto">
  ...
  <img class="d-block mx-auto mb-4" src="img/34.png" alt="" width="150" height="100">
    ...
    <div class="form-floating">
      ...
      <div>
          <li class="list-line-item">Don't have an account? <a href="register.php">Register Now</a> </li>
        </ul>
      </div>
      </label>
    </div>
